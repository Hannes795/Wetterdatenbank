...
error::error(error_id idc, string error_typec, string error_stringc, string error_positionc, string previous_error_stringc) {
	id = idc;
...
string error::error_output_string() {
	...
	string part5 = "\nError type: \t";
	string line_break = "\n";
	output_string = part1 + part2 + part3 + to_string(int(id)) + part4 + error_position + part5 + error_type + line_break + error_string;
